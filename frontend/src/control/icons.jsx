...
export const Icon = {
  ...
  up: (p) => <svg {...base} {...p}><path d="m6 15 6-6 6 6" /></svg>,
  down: (p) => <svg {...base} {...p}><path d="m6 9 6 6 6-6" /></svg>,
  plus: (p) => <svg {...base} {...p}><path d="M12 5v14M5 12h14" /></svg>,
  trash: (p) => <svg {...base} {...p}><path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13M10 11v6M14 11v6" /></svg>,
  edit: (p) => <svg {...base} {...p}><path d="M4 20h4L19 9l-4-4L4 16zM13.5 6.5l4 4" /></svg>,
